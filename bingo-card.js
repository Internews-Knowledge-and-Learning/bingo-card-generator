...
options.push("Someone (not you) rocks out to intro music on camera",
             ...
             "Tag yourself with at least three workplace skills or programmatic expertise areas directory",
             "Tag yourself with your preferred and/or proficient languages in the people directory",
             "Attend three GIG sessions","Submit three times to the gratitude wall",
             "Receive three notifications from the gratitude wall",
             ...
             "'Can you see my screen?'","Someone (other than you!) has a custom Teams backdrop",
             "Someone's pet shows up on camera","Someone (other than you!) shares a relevant GIF in the chat",
             "Someone screenshares something that ISN'T powerpoint","'Next slide please'",
             "A group of people join a session from the same room (camera on)",
             "You attend a session that uses Mentimeter","You attend a session that uses Kahoot",
             "You end up on the podium in one of the games... or come dead last",
             "You present in a GIG session","Every team/office is included in the annual roll call :)",
